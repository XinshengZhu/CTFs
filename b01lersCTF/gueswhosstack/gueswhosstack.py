...
# Overwrite GOT entry of memcpy (__memmove_evex_unaligned_erms is called by printf) with gets
...
# Overwrite GOT entry of memchr (__memchr_evex is called by gets) with system
